...
export function getFileFullName(fileUrl: string): string | undefined {
  return fileUrl.split("/").pop();
}

export function getFileFormat(fileUrl: string): string {
  let format;
...
export function getFileThumb(fileUrl: string): JSX.Element {
  let thumb;
