...
export default function SettingMode(): JSX.Element {
  const { getThemeMode, setThemeMode } = useAppearance();
  const themeMode: PaletteMode = getThemeMode();
  const onChangeMode = (event: React.ChangeEvent<HTMLInputElement>) => {
    setThemeMode((event.target as HTMLInputElement).value as PaletteMode);
  };
